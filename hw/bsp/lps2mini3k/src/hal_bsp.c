...
#if MYNEWT_VAL(DW3000_DEVICE_0)
    hal_gpio_init_out(DWX000_ENABLE_N_PIN, 0);
    os_cputime_delay_usecs(30000);

    dw3000_0 = hal_dw3000_inst(0);
    int rc = os_dev_create((struct os_dev *) dw3000_0, "dw3000_0",
      OS_DEV_INIT_PRIMARY, 0, dw3000_dev_init, (void *)&dw3000_0_cfg);
    assert(rc == 0);
#else
    hal_gpio_init_out(DWX000_ENABLE_N_PIN, 1);
#endif
