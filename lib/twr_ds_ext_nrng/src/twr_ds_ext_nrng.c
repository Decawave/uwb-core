...
rx_complete_cb(struct uwb_dev * inst, struct uwb_mac_interface * cbs)
{
    ...
    assert(inst->nrng);
    struct nrng_instance * nrng = inst->nrng;
    struct uwb_rng_config * config = nrng_get_config(inst, UWB_DATA_CODE_DS_TWR_NRNG_EXT);
    switch(inst->nrng->code){
        case UWB_DATA_CODE_DS_TWR_NRNG_EXT:
            {
                ...
                frame->code = UWB_DATA_CODE_DS_TWR_NRNG_EXT_T1;
        ...
        case UWB_DATA_CODE_DS_TWR_NRNG_EXT_T1:
            {
                ...
                frame->dst_address = frame->src_address;
                frame->src_address = inst->my_short_address;
                frame->code = UWB_DATA_CODE_DS_TWR_NRNG_EXT_T2;
        ...
        case UWB_DATA_CODE_DS_TWR_NRNG_EXT_T2:
            {
                ...
                frame->dst_address = frame->src_address;
                frame->src_address = inst->my_short_address;
                frame->code = UWB_DATA_CODE_DS_TWR_NRNG_EXT_FINAL;
        ...
        case  UWB_DATA_CODE_DS_TWR_NRNG_EXT_FINAL:
            {
