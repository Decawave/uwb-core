        ...
        case UWB_DATA_CODE_SS_TWR_NRNG:
            {
                ...
                uint64_t response_tx_delay = request_timestamp
                            ...
                            + (uint64_t)(uwb_usecs_to_dwt_usecs(uwb_phy_frame_duration(inst, sizeof(nrng_response_frame_t), 0))))))<< 16);
        ...
        case UWB_DATA_CODE_SS_TWR_NRNG_T1:
            {
                ...
                if(idx == nrng->nnodes-1){
                    ...
                    uint16_t timeout = usecs_to_response(inst,
                                ...
                                config,                            // Guard delay
                                uwb_phy_frame_duration(inst, sizeof(nrng_response_frame_t), 0) // frame duration in usec
