...
{
    int rc;
    char *output1 = "{\"utime\": 1,\"seq\": 2,\"c\": 3,\"uid\": 4,\"ouid\": 5,\"raz\": [1.0000,2.0000,3.0000],\"braz\": [1.0000,2.0000,3.0000],\"rssi\": [1.0000,2.0000,3.0000],\"los\": [1.0000,2.0000,3.0000],\"ppm\": 6.0000,\"sts\": 7.0000}";
    char *output2 = "{\"utime\": 0,\"raz\": [null]}";
    char *output3 = "{\"utime\": 1,\"seq\": 2,\"c\": 3,\"uid\": 4,\"raz\": [0.0000,0.0000,0.0000],\"braz\": [1.0000,2.0000,3.0000],\"rssi\": [1.0000,2.0000,3.0000],\"los\": [0.0000,0.0000,0.0000]}";
    char *output4 = "{\"utime\": 0,\"raz\": [0.0000,0.0000,0.0000],\"braz\": [0.0000,0.0000,0.0000],\"rssi\": [0.0000,0.0000,0.0000],\"los\": [0.0000,0.0000,0.0000],\"ppm\": 0.0000,\"sts\": 0.0000}";
