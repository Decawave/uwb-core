...
set(AS                  xtensa-lx106-elf-as)
set(AR                  xtensa-lx106-elf-ar)
set(OBJCOPY             xtensa-lx106-elf-objcopy)
set(OBJDUMP             xtensa-lx106-elf-objdump)
set(SIZE                xtensa-lx106-elf-size)

set(CMAKE_C_FLAGS   "${MCPU_FLAGS} ${VFP_FLAGS} -Wall -fno-builtin -std=gnu11 -fdata-sections -ffunction-sections -mtext-section-literals -mlongcalls" CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS "${MCPU_FLAGS} ${VFP_FLAGS} -Wall -fno-builtin -fdata-sections -ffunction-sections -mtext-section-literals -mlongcalls" CACHE INTERNAL "cxx compiler flags")
